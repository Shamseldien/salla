...
class ProductInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (context)=>di<ProductInfoCubit>()..getProductInfo(productId: id),
    child: BlocConsumer<ProductInfoCubit,ProductInfoStates>(
      ...
      builder: (context,state){
        ...
        return Scaffold(
          appBar: AppBar(
            elevation: 1,
            title: Text(model!=null?model.data.name:'',overflow: TextOverflow.ellipsis,maxLines: 1,),
          ),
          body: SafeArea(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('${model.data.price.round()} SAR',style: black14().copyWith(
                              color: Colors.blue
                          ),),
                          if(model.data.discount>0)
                          Row(
                            children: [
                              Text('${model.data.oldPrice.round()} SAR',style: grey12().copyWith(
                                  height: 1.2,
                          ...
                          Text('Description',style: black18(),),
                          SizedBox(
                            height: 10,
                          ),
